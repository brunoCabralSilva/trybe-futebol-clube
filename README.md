...
2️⃣ **Back-end:**
 - Será o ambiente onde será desenvolvida toda a lógica que fornecerá as informações devidamente processadas no banco de dados para o front-end.

3️⃣ **Front-end:**
  - Container responsável por consultar as informações fornecidas pelo back-end e apresentá-las ao usário de forma interativa.
...
⚠️ A biblioteca utilizada para criptografar a senha no banco de dados é a `bcryptjs` [bcryptjs npm](https://www.npmjs.com/package/bcryptjs) e é utilizada para realizar a verificação entre a senha fornecida pelo usuário e as senhas salvas no banco.
